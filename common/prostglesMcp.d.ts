            ...
            readonly schema: {
                readonly type: {
                    ...
                    readonly mcpServerTools: {
                        ...
                        readonly descoription: "List of MCP server tools to enable for this chat.";
                        readonly optional: true;
                    };
            ...
            readonly schema: {
                readonly type: {
                    ...
                    readonly workflowId: {
                        ...
                        readonly optional: true;
                        readonly description: "Workflow ID to update instead of creating a new workflow. If not provided, a new workflow will be created.";
                    };
                };
            };
            readonly outputSchema: {
