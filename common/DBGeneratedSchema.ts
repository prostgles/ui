...
export type DBGeneratedSchema = {
 ...
 |  {  mode: "execute_sql";  allowedCommands?: Partial<Record<"select" | "insert" | "update" | "delete", 1>>; }
 |  {  mode: "custom";  tablePermissions: Record<string,  {  select?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  update?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  insert?: | true |  {  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  delete?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; }; }; }>;  ddlStatements?: string; };   agentDefinitions?: Partial<Record<string,  {  prompt?: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  tools?: Partial<Record<string,  Partial<Record<string, 1>>>>;  mcpServerConfigs?: Partial<Record<string,  {  configId: number; }>>;  maxTokens?: number;  temperature?: number; }>>;   containerConfiguration?: {  timeout?: number;  cpus?: string;  memory?: string;  readOnly?: boolean;  internetAccess?: "none" | "bridge" | "host"; };   orchestratorMcpServerConfigs?: Partial<Record<string,  {  configId: number; }>>;  };
  ...
  alerts: {
    columns: {
      ...
      ui_path?: 
       | null
       |  {  page: "/connection-config";  section: "authentication" | "access_control" | "backups" | "table_config" | "details" | "status" | "methods" | "file_storage" | "API" | "webApp" | "security" | "config"; }
  ...
  connections: {
    columns: {
      ...
      table_options?: null | Partial<Record<string,  {  icon?: string;  label?: string;  sort?: (  {  key: string;  asc: boolean;  nulls?: "first" | "last"; } )[];  rowIconColumn?: string;  columns?: Partial<Record<string,  {  icon?: string;  renderAs?: |  {  type: "NONE"; } |  {  type: "URL"; } |  {  type: "Email"; } |  {  type: "Tel"; } |  {  type: "QR Code"; } |  {  type: "Currency";  params: |  {  mode: "Fixed";  metricPrefix?: boolean;  currencyCode: string; } |  {  mode: "From column";  metricPrefix?: boolean;  currencyCodeField: string; }; } |  {  type: "Metric Prefix"; } |  {  type: "UNIX Timestamp"; } |  {  type: "Age";  params?: {  variant: "short" | "full"; }; } |  {  type: "Markdown" | "MarkdownPopup"; } |  {  type: "JSON Diff" | "Text Diff";  params: {  oldColumn: string;  newColumn: string; }; } |  {  type: "DoclingDocument"; } |  {  type: "Logs"; } |  {  type: "HTML";  params: {  noSanitize?: boolean;  allowedHTMLTags?: ("img" | "video" | "audio" | "svg" | "path")[]; }; } |  {  type: "Media";  params: {  contentType?: |  {  mode: "Auto"; } |  {  mode: "Fixed";  fixedContentType: ("image" | "video" | "audio"); } |  {  mode: "From column";  contentTypeColumnName: string; } |  {  mode: "From URL Extension"; };  titleColumn?: string; }; };  style?: |  {  type: "Conditional";  column?: string;  conditions: (  |  {  operator: "contains" | "=" | ">" | ">=" | "<" | "<=" | "!=";  condition: any;  textColor?: string;  chipColor?: string;  cellColor?: string;  borderColor?: string; } |  {  operator: "in" | "not in";  condition: any[];  textColor?: string;  chipColor?: string;  cellColor?: string;  borderColor?: string; } )[];  defaultStyle?: {  textColor?: string;  chipColor?: string;  cellColor?: string;  borderColor?: string; }; } |  {  type: "Scale";  textColor: string;  minColor: string;  maxColor: string; } |  {  type: "Barchart";  barColor: string;  textColor: string; }; }>>;  card?: {  avatarColumn?: string;  headerColumn?: string;  subHeaderColumn?: string;  visibleColumns?: (  | string |  {  column: string;  hideLabel?: boolean; } )[]; }; }>>
 ...
 |  {  command: "pg_dump";  format: "p" | "t" | "c";  dataOnly?: boolean;  clean?: boolean;  create?: boolean;  encoding?: string;  numberOfJobs?: number;  noOwner?: boolean;  compressionLevel?: number;  ifExists?: boolean;  keepLogs?: boolean;  excludeSchema?: string;  schemaOnly?: boolean; };  };
      config_sync?: null | {    configPath: string;   type: "sample-schema" | "cli";   toggleableProperties: Partial<Record<"tableConfig" | "functions" | "onMount", 1>>;   lastSynced: string;  };
 ...
 |  {  type: "S3";  credential_id: number; };   referencedTables?: Record<string, any>;   delayedDelete?: {  deleteAfterNDays: number;  checkIntervalHours?: number; };   annotationsTable?: string;   extractText?: boolean;  };
      id?: number;
 ...
 |  {  columns: Record<string,  | string |  {  hint?: string;  nullable?: boolean;  isText?: boolean;  trimmed?: boolean;  defaultValue?: any; } |  {  jsonbSchema: |  {  type: "string" | "number" | "boolean" | "Date" | "time" | "timestamp" | "string[]" | "number[]" | "boolean[]" | "Date[]" | "time[]" | "timestamp[]";  optional?: boolean;  description?: string; } |  {  type: "RowLookup" | "RowLookup[]" | "ValueLookup" | "ValueLookup[]" | "TableLookup" | "TableLookup[]" | "ColumnLookup" | "ColumnLookup[]";  optional?: boolean;  description?: string; } |  {  type: "object";  optional?: boolean;  description?: string; }; }>; }>
  ...
  llm_chats: {
    columns: {
      ...
      db_data_permissions?: 
       ...
       |  {  mode: "execute_sql";  allowedCommands?: Partial<Record<"select" | "insert" | "update" | "delete", 1>>;  query_timeout?: number;  auto_approve?: boolean; }
 ...
 |  {  max_tokens?: number; };   stream?: boolean;  };
  ...
  mcp_server_configs: {
    columns: {
      config: 
       |  {  type: "OAuth";  scopes: string[];  savePngIcon: boolean;  auth: |  {  mode: "none" | "dcr"; } |  {  mode: "cimd";  clientMetadataUrl: string; } |  {  mode: "bearer";  bearerToken: string; } |  {  mode: "authorization_code";  clientId: string;  clientSecret: string; } |  {  mode: "client_credentials";  clientId: string;  clientSecret: string;  tokenEndpoint: string; }; }
       |  {  type: "local";  value: Record<string, unknown>; }
      created?: null | string;
      id?: number;
      last_updated?: null | string;
      oauth?: 
       | null
       |  {  phase: "initializing_dcr";  redirectUri: string;  scopes: string[]; }
       |  {  phase: "initializing_client";  tokenEndpoint: string;  scopes: string[];  discoveryState: Record<string, unknown>;  clientInformation: Record<string, unknown>;  redirectUri: string; }
       |  {  phase: "initializing_bearer_token";  redirectUri: string;  bearerToken: string;  scopes: string[]; }
       |  {  phase: "error";  error: string;  errorType: "dcr_not_supported" | "unknown";  redirectUri: string;  scopes: string[]; }
       |  {  phase: "awaiting_authorization";  scopes: string[];  discoveryState: Record<string, unknown>;  clientInformation: Record<string, unknown>;  redirectUri: string;  authorizationUrl: string;  codeVerifier: string; }
       |  {  phase: "exchanging_code";  scopes: string[];  discoveryState: Record<string, unknown>;  clientInformation: Record<string, unknown>;  redirectUri: string;  codeVerifier: string;  pendingAuthorizationCode: string; }
       |  {  phase: "connected";  scopes: string[];  discoveryState: Record<string, unknown>;  clientInformation: Record<string, unknown>;  redirectUri: string;  tokens: Record<string, unknown>;  clientSecret?: string; }
       |  {  phase: "connected_bearer";  bearerToken: string; }
  ...
  mcp_server_tools: {
    columns: {
      ...
      description: string;
      icon?: null | string;
      icons?: null |  (  {  src: string;  mimeType?: string;  sizes?: string[];  theme?: "light" | "dark"; } )[]
      id?: number;
 ...
 |  {  name: string;  type: "ColumnLookup" | "ColumnLookup[]";  defaultValue?: any;  optional?: boolean; }
 |  {  name: string;  type: "JsonbSchema";  defaultValue?: any;  optional?: boolean;  schema: |  {  type: "boolean" | "number" | "integer" | "string" | "Date" | "time" | "timestamp" | "Uint8Array" | "Blob" | "FileLike" | "any" | "unknown" | "boolean[]" | "number[]" | "integer[]" | "string[]" | "Date[]" | "time[]" | "timestamp[]" | "Uint8Array[]" | "Blob[]" | "FileLike[]" | "any[]" | "unknown[]";  optional?: boolean;  nullable?: boolean;  description?: string;  title?: string;  defaultValue?: any; } |  {  type: "object" | "object[]";  optional?: boolean;  nullable?: boolean;  description?: string;  title?: string;  defaultValue?: any;  properties: Record<string,  {  type: "boolean" | "number" | "integer" | "string" | "Date" | "time" | "timestamp" | "Uint8Array" | "Blob" | "FileLike" | "any" | "unknown" | "boolean[]" | "number[]" | "integer[]" | "string[]" | "Date[]" | "time[]" | "timestamp[]" | "Uint8Array[]" | "Blob[]" | "FileLike[]" | "any[]" | "unknown[]";  optional?: boolean;  nullable?: boolean;  description?: string;  title?: string;  defaultValue?: any; }>; }; } )[]
      connection_id?: null | string;
      description?: string;
      id?: number;
      name?: string;
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "tool_result";  tool_use_id: string;  tool_name: string;  content: | string |  (  |  {  type: "text";  text: string; } |  {  type: "image" | "audio";  mimeType: string;  data: string; } |  {  type: "resource";  resource: {  uri: string;  mimeType?: string;  text?: string;  blob?: string; }; } |  {  type: "resource_link";  uri: string;  name: string;  mimeType?: string;  description?: string; } )[];  is_error?: boolean; } )[];  }) => Promise<void>;
  ...
  "readFile": (args: {    filePath: string;  }) => Promise<string>;
  "saveFile": (args: {    filePath: string;   content: string;  }) => Promise<boolean>;
  ...
  "runSql": (args: {    connectionId: string;   query: string;   mode?: "default" | "readOnly";   args?: any;  }) => Promise<{ command: string; fields: Array<{ tsDataType: ("string" | "number" | "boolean" | "any" | "Uint8Array" | "string[]" | "number[]" | "boolean[]" | "any[]"); dataType: ("name" | "time" | "timestamp" | "text" | "path" | "json" | "bpchar" | "char" | "varchar" | "citext" | "uuid" | "timetz" | "interval" | "cidr" | "inet" | "macaddr" | "macaddr8" | "int4range" | "int8range" | "numrange" | "tsvector" | "int2" | "int4" | "float4" | "float8" | "oid" | "int8" | "numeric" | "money" | "point" | "line" | "lseg" | "box" | "polygon" | "circle" | "jsonb" | "bool" | "date" | "timestamptz" | "geometry" | "geography" | "bytea"); udt_name: ("name" | "time" | "timestamp" | "text" | "path" | "json" | "bpchar" | "char" | "varchar" | "citext" | "uuid" | "timetz" | "interval" | "cidr" | "inet" | "macaddr" | "macaddr8" | "int4range" | "int8range" | "numrange" | "tsvector" | "int2" | "int4" | "float4" | "float8" | "oid" | "int8" | "numeric" | "money" | "point" | "line" | "lseg" | "box" | "polygon" | "circle" | "jsonb" | "bool" | "date" | "timestamptz" | "geometry" | "geography" | "bytea"); tableName: (undefined | string); tableSchema: (undefined | string); columnName: (undefined | string); name: string; oid: number; dataTypeID: number; tableID: number; columnID: number; dataTypeSize: number; dataTypeModifier: number; format: string }>; rowCount: number; rows: Array<unknown>; duration: (undefined | number) }>;
  ...
  "getFileFolderSizeInBytes": (args: {    conId?: string;  }) => Promise<{ size: number; storagePath: string }>;
  "testDBConnection": (args: {    connection: Record<string, unknown>;  }) => Promise<{ prostglesSchemaVersion: (undefined | string); connectionInfo: { ssl: (false | true | { ca?: (undefined | string | ArrayBuffer | Uint8Array | Array<(string | ArrayBuffer | Uint8Array)>); pfx?: (undefined | string | ArrayBuffer | Uint8Array | Array<(string | object | ArrayBuffer | Uint8Array)>); cert?: (undefined | string | ArrayBuffer | Uint8Array | Array<(string | ArrayBuffer | Uint8Array)>); key?: (undefined | string | ArrayBuffer | Uint8Array | Array<(object | ArrayBuffer | Uint8Array)>); passphrase?: (undefined | string); rejectUnauthorized?: (undefined | false | true); secureOptions?: (undefined | number); NPNProtocols?: (undefined | Array<string> | ArrayBuffer | Uint8Array | Uint8Array<(ArrayBuffer | SharedArrayBuffer)> | Array<ArrayBuffer | Uint8Array> | Array<Uint8Array<(ArrayBuffer | SharedArrayBuffer)>>) }); application_name: string; host: string; port: number; user: string; database: string; password: string; connectionTimeoutMillis?: (undefined | number) }; canCreateDb: (undefined | false | true); isSSLModeFallBack?: (undefined | false | true) }>;
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  "setFileStorage": (args: {    connId: string;   tableConfig?: {  fileTable?: string;  storageType: |  {  type: "local"; } |  {  type: "S3";  credential_id: number; };  referencedTables?: Record<string, any>;  delayedDelete?: {  deleteAfterNDays: number;  checkIntervalHours?: number; };  annotationsTable?: string;  extractText?: boolean; };   opts?: {  keepS3Data?: boolean;  keepFileTable?: boolean; };  }) => Promise<void>;
  ...
  "setOnMount": (args: {    connId: string;   changes: {  on_mount_ts_disabled?: boolean; };  }) => Promise<void>;
  "setTableConfig": (args: {    connId: string;   changes: {  table_config_ts?: string;  table_config_ts_disabled?: boolean; };  }) => Promise<void>;
  "getNodeTypes": (args: {    projectPath?: string;  }) => Promise<Array<{ content: string; filePath: string }>>;
