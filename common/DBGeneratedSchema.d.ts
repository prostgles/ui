...
export type DBGeneratedSchema = {
 ...
 |  {  type: "S3";  credential_id: number; };   referencedTables?: Record<string, any>;   delayedDelete?: {  deleteAfterNDays: number;  checkIntervalHours?: number; };   citationsTable?: string;  };
      id?: number;
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  "setFileStorage": (args: {    connId: string;   tableConfig?: {  fileTable?: string;  storageType: |  {  type: "local"; } |  {  type: "S3";  credential_id: number; };  referencedTables?: Record<string, any>;  delayedDelete?: {  deleteAfterNDays: number;  checkIntervalHours?: number; };  citationsTable?: string; };   opts?: {  keepS3Data?: boolean;  keepFileTable?: boolean; };  }) => Promise<void>;
