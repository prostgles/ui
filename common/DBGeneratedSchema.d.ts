...
export type DBGeneratedSchema = {
 ...
 |  Record<string,  Record<string, 1>>;  };
      definition_override?: null | {    agentDefinitions?: Partial<Record<string,  {  prompt?: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  allowedToolDefinitionNames?: string[];  maxTokens?: number;  temperature?: number; }>>;   timeOutInSeconds?: number;  };
      id?: number;
      name: string;
      user_id: string;
    };
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  mode: "execute_sql_with_commit" | "execute_sql_with_rollback"; };   toolDefinitions: Record<string,  {  mcpServerName: string;  toolNames: string[];  configId?: number; }>;   workflowAllowedTools: | undefined
