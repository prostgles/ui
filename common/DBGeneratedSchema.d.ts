...
export type DBGeneratedSchema = {
 ...
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date"; }>;   newTables?: (  {  name: string;  schema?: string;  columns: (  {  name: string;  dataType: string;  nullable?: boolean;  isPrimaryKey?: boolean; } )[]; } )[];   orchestrationTools?: | undefined
