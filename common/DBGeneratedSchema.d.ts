...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  ...
  "authenticateMcpServer": (args: {    serverName: string;   origin: string;   scopes: string[];   clientMetadataUrl?: string;   authMode: "dcr" | "cimd";  }) => Promise<{ authorizationUrl: string }>;
