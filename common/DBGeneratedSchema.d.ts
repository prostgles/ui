...
export type DBGeneratedSchema = {
 ...
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date";  defaultValue?: unknown; }>;   newTables?: (  {  name: string;  schema?: string;  columns: (  {  name: string;  dataType: string;  nullable?: boolean;  isPrimaryKey?: boolean; } )[]; } )[];   orchestrationTools?: | undefined
 ...
 |  {  columns: Record<string,  | string |  {  hint?: string;  nullable?: boolean;  isText?: boolean;  trimmed?: boolean;  defaultValue?: any; } |  {  jsonbSchema: |  {  type: "string" | "number" | "boolean" | "Date" | "time" | "timestamp" | "string[]" | "number[]" | "boolean[]" | "Date[]" | "time[]" | "timestamp[]";  optional?: boolean;  description?: string; } |  {  type: "Lookup" | "Lookup[]";  optional?: boolean;  description?: string; } |  {  type: "object";  optional?: boolean;  description?: string; }; }>; }>
  ...
  docker_containers: {
    columns: {
      chat_id: number;
      configuration: {    userInputValue?: Record<string, unknown>;   files: Partial<Record<string, string>>;   timeout?: number;   networkMode?: "none" | "bridge" | "bridge-internal" | "host";   environment?: Partial<Record<string, string>>;   memory?: string;   cpus?: string;   readOnly?: boolean;   userInput?: Record<string, 
 |  {  title: string;  optional?: boolean;  type: "table-column-value";  tableName: string;  columnName: string;  defaultValue?: any; }
 |  {  title: string;  optional?: boolean;  type: "table-column-values";  tableName: string;  columnName: string;  defaultValue?: any[]; }
 |  {  title: string;  optional?: boolean;  type: "table-filter";  tableName: string;  defaultValue?: Record<string, any>; }
 |  {  title: string;  optional?: boolean;  type: "table-column";  tableName: string;  defaultValue?: string; }
 ...
 |  {  max_tokens?: number; };   stream?: boolean;  };
  ...
  llm_prompts: {
    columns: {
      ...
      id?: number;
      name?: string;
      options?: null | {    max_tokens?: number;   temperature?: number;   mcp_server_tools?: Partial<Record<string,  Partial<Record<string, 1>>>>;   database_access?: "execute_readonly_sql";  };
      prompt?: string;
      user_id?: null | string;
    };
  };
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "tool_result";  tool_use_id: string;  tool_name: string;  content: | string |  (  |  {  type: "text";  text: string; } |  {  type: "image" | "audio";  mimeType: string;  data: string; } |  {  type: "resource";  resource: {  uri: string;  mimeType?: string;  text?: string;  blob?: string; }; } |  {  type: "resource_link";  uri: string;  name: string;  mimeType?: string;  description?: string; } )[];  is_error?: boolean; } )[];  }) => Promise<void>;
  ...
  "buildWebApp": (args: {    connectionId: string;   clean?: boolean;  }) => Promise<{ state: ("close" | "error" | "timed-out" | "aborted"); command: string; exitCode: number; timedOut: boolean; executionTime: number; log: Array<{ type: ("error" | "stderr" | "stdout"); text: string }> }>;
  "testWebApp": (args: {    connectionId: string;  }) => Promise<{ state: ("close" | "error" | "timed-out" | "aborted"); command: string; exitCode: number; timedOut: boolean; executionTime: number; log: Array<{ type: ("error" | "stderr" | "stdout"); text: string }> }>;
  ...
  "runSql": (args: {    connectionId: string;   query: string;   mode?: "default" | "readOnly";   args?: any;  }) => Promise<{ command: string; fields: Array<{ tsDataType: ("string" | "number" | "boolean" | "any" | "number[]" | "boolean[]" | "string[]" | "any[]"); dataType: ("name" | "time" | "timestamp" | "text" | "path" | "json" | "bpchar" | "char" | "varchar" | "citext" | "uuid" | "bytea" | "timetz" | "interval" | "cidr" | "inet" | "macaddr" | "macaddr8" | "int4range" | "int8range" | "numrange" | "tsvector" | "int2" | "int4" | "float4" | "float8" | "oid" | "int8" | "numeric" | "money" | "point" | "line" | "lseg" | "box" | "polygon" | "circle" | "jsonb" | "bool" | "date" | "timestamptz" | "geometry" | "geography"); udt_name: ("name" | "time" | "timestamp" | "text" | "path" | "json" | "bpchar" | "char" | "varchar" | "citext" | "uuid" | "bytea" | "timetz" | "interval" | "cidr" | "inet" | "macaddr" | "macaddr8" | "int4range" | "int8range" | "numrange" | "tsvector" | "int2" | "int4" | "float4" | "float8" | "oid" | "int8" | "numeric" | "money" | "point" | "line" | "lseg" | "box" | "polygon" | "circle" | "jsonb" | "bool" | "date" | "timestamptz" | "geometry" | "geography"); tableName: (undefined | string); tableSchema: (undefined | string); columnName: (undefined | string); name: string; oid: number; dataTypeID: number; tableID: number; columnID: number; dataTypeSize: number; dataTypeModifier: number; format: string }>; rowCount: number; rows: Array<unknown>; duration: (undefined | number) }>;
