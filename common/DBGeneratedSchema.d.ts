...
export type DBGeneratedSchema = {
 ...
 |  {  title: string;  optional?: boolean;  type: "table-column-value" | "table-column-values";  tableName: string;  columnName: string; }
 ...
 |  {  title: string;  optional?: boolean;  type: "enum";  values: string[]; }
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date"; }>;   newTables?: (  {  name: string;  columns: (  {  name: string;  dataType: string; } )[]; } )[];   orchestrationTools?: | undefined
 |  Partial<Record<string,  Partial<Record<string, 1>>>>;  };
      definition_override?: null | {    agentDefinitions?: Partial<Record<string,  {  prompt?: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  tools?: Partial<Record<string,  Partial<Record<string, 1>>>>;  maxTokens?: number;  temperature?: number; }>>;   containerConfiguration?: {  timeout?: number;  cpus?: string;  memory?: string;  readOnly?: boolean;  internetAccess?: "none" | "full"; };  };
      id?: number;
      name: string;
      user_id: string;
    };
 ...
 |  {  max_tokens?: number; };   stream?: boolean;  };
  ...
  llm_prompts: {
    columns: {
      ...
      id?: number;
      name?: string;
      options?: null | {    max_tokens?: number;   temperature?: number;   mcp_server_tools?: Partial<Record<string,  Partial<Record<string, 1>>>>;   database_access?: "execute_sql_with_rollback";  };
      prompt?: string;
      user_id?: null | string;
    };
  };
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  ...
  "getAgenticWorkflowTypes": () => Promise<{ "defineAgenticWorkflow.ts": string; "defineAgenticWorkflowHandlers.ts": string }>;
  ...
  "startAgenticWorkflow": (args: {    chatId: number;   messageId: string;   workflowId: number;   name: string;   workflowTs: string;   containerConfiguration: {  timeout: number;  cpus?: string;  memory?: string;  readOnly?: boolean;  internetAccess?: "none" | "full"; };   executionMode: "series" | "parallel";   databaseAccessDefinitions?: |  {  mode: "execute_sql_with_rollback" | "execute_sql_with_commit"; }
 |  {  mode: "custom";  tablePermissions: Record<string,  {  select?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  update?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  insert?: | true |  {  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  delete?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; }; }; }>;  tableCreateStatements?: string; };   orchestrationTools?: | undefined
 |  Partial<Record<string,  Partial<Record<string, 1>>>>;   agentDefinitions?: Record<string,  {  prompt: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  tools?: Partial<Record<string,  Partial<Record<string, 1>>>>;  maxTokens?: number;  temperature?: number;  outputSchema: Record<string,  |  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; } |  {  optional?: boolean;  type: Record<string,  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; }>; } |  {  optional?: boolean;  arrayOfType: Record<string,  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; }>; }>; }>;   userInput?: Record<string, 
 |  {  title: string;  optional?: boolean;  type: "table-column-value" | "table-column-values";  tableName: string;  columnName: string; }
 |  {  title: string;  optional?: boolean;  type: "table-filter" | "table-column";  tableName: string; }
 |  {  title: string;  optional?: boolean;  type: "table-name" | "table-and-column"; }
 |  {  title: string;  optional?: boolean;  type: "enum";  values: string[]; }
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date"; }>;   userInputValue: Record<string, unknown>;   newTables?: (  {  name: string;  columns: (  {  name: string;  dataType: string; } )[]; } )[];  }) => Promise<(({} & { state: ("error" | "finished" | "build-error" | "timed-out" | "aborted"); name: string; command: string; log: Array<({} & { type: ("error" | "stdout" | "stderr"); text: string })>; exitCode: number; runDuration: number; buildDuration: number }) | { state: "init-error"; message: string; error: unknown })>;
