...
export type DBGeneratedSchema = {
 ...
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date"; }>;   timeOutInSeconds: number;   newTables?: (  {  name: string;  columns: (  {  name: string;  dataType: string; } )[]; } )[];   workflowAllowedTools: | undefined
 |  Record<string,  Record<string, 1>>;  };
      definition_override?: null | {    agentDefinitions?: Partial<Record<string,  {  prompt?: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  tools?: Record<string,  Record<string, 1>>;  maxTokens?: number;  temperature?: number; }>>;   timeOutInSeconds?: number;  };
      id?: number;
      name: string;
      user_id: string;
    };
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  ...
  "callMCPServerTool": (args: {    chatId: number;   serverName: string;   toolName: string;   reRunToolUseId?: string;   args?: Record<string, any>;  }) => Promise<{ _meta?: (undefined | { [key: string]: any }); content: Array<({ type: "text"; text: string } | { type: ("image" | "audio"); data: string; mimeType: string } | { type: "resource"; resource: { uri: string; mimeType?: (undefined | string); text?: (undefined | string); blob?: (undefined | string) } } | { type: "resource_link"; uri: string; name: string; mimeType?: (undefined | string); description?: (undefined | string) })>; isError?: (undefined | false | true) }>;
  ...
  "startAgenticWorkflow": (args: {    chatId: number;   messageId: string;   workflowId: number;   name: string;   workflowTs: string;   timeOutInSeconds: number;   executionMode: "series" | "parallel";   databaseAccessDefinitions?: |  {  mode: "custom";  tableCreateStatements?: string;  tablePermissions: Record<string,  {  select?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  update?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; };  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  insert?: | true |  {  fields: | "*" |  Record<string, 1> |  Record<string, 0>; };  delete?: | true |  {  forcedFilter?: |  {  $and: any[]; } |  {  $or: any[]; }; }; }>; }
 |  {  mode: "execute_sql_with_commit" | "execute_sql_with_rollback"; };   workflowAllowedTools: | undefined
 |  Record<string,  Record<string, 1>>;   agentDefinitions: Record<string,  {  prompt: string;  modelName?: string;  maxCostUSD?: number;  maxIterations?: number;  tools?: Record<string,  Record<string, 1>>;  maxTokens?: number;  temperature?: number;  outputSchema: Record<string,  |  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; } |  {  optional?: boolean;  type: Record<string,  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; }>; } |  {  optional?: boolean;  arrayOfType: Record<string,  {  optional?: boolean;  type: "string" | "number" | "boolean" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]"; }>; }>; }>;   userInput?: Record<string, 
 |  {  title: string;  optional?: boolean;  type: "table-filter" | "table-column";  tableName: string; }
 |  {  title: string;  optional?: boolean;  type: "table-name" | "table-and-column"; }
 |  {  title: string;  optional?: boolean;  type: "custom";  dataType: "string" | "number" | "boolean" | "Date"; }>;   userInputValue: Record<string, unknown>;   newTables?: (  {  name: string;  columns: (  {  name: string;  dataType: string; } )[]; } )[];  }) => Promise<(({} & { state: ("error" | "finished" | "build-error" | "timed-out" | "aborted"); name: string; command: string; log: Array<({} & { type: ("error" | "stdout" | "stderr"); text: string })>; exitCode: number; runDuration: number; buildDuration: number }) | { state: "init-error"; message: string; error: unknown })>;
  ...
  "updateAgenticWorkflow": (args: {    workflowId: number;   chatId: number;   workflow_function_definition: string;  }) => Promise<void>;
