...
export type DBGeneratedSchema = {
 ...
 |  {  max_tokens?: number; };   stream?: boolean;  };
  ...
  mcp_server_configs: {
    columns: {
      config: 
       |  {  type: "OAuth";  scopes: string[];  savePngIcon: boolean;  auth: |  {  mode: "none" | "dcr"; } |  {  mode: "cimd";  clientMetadataUrl: string; } |  {  mode: "bearer";  bearerToken: string; } |  {  mode: "client_credentials" | "authorization_code";  clientId: string;  clientSecret: string; }; }
...
export type GeneratedFunctionSchema = { 
 ...
 |  {  type: "end";  streamId: string; };  }) => Promise<(undefined | string)>;
  ...
  "authenticateMcpServer": (args: {    serverName: string;   origin: string;   config: {  type: "OAuth";  scopes: string[];  savePngIcon: boolean;  auth: |  {  mode: "none" | "dcr"; } |  {  mode: "cimd";  clientMetadataUrl: string; } |  {  mode: "bearer";  bearerToken: string; } |  {  mode: "client_credentials" | "authorization_code";  clientId: string;  clientSecret: string; }; };  }) => Promise<void>;
