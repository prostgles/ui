...
import { AuthClientRequest, BasicSession, LoginClientInfo } from 'prostgles-server/dist/AuthHandler';
...
export declare const getAuth: (app: Express) => {
    ...
    getUser: (sid: string | undefined, db: {
        ...
        credentials: import("prostgles-types").TableHandler<{
            ...
            user_id?: string | null | undefined; /** For security reasons provide state_db_id only to admin users */
        }>;
        ...
        links: import("prostgles-types").TableHandler<{
            ...
            options: {
                ...
                type: "map";
                colorArr?: number[] | undefined; /** Keep last 20 sessions */
                smartGroupFilter?: {
                    $and: any[];
                } | {
                    $or: any[];
    ...
    }>, "tx" | "sql">, _db: DB, client: AuthClientRequest & LoginClientInfo) => Promise<SUser | undefined>;
    login: ({ username, password, totp_token, totp_recovery_code }: import("prostgles-types").AnyObject | undefined, db: {
        access_control: import("prostgles-types").TableHandler<{
            created?: string | null | undefined;
            database_id?: number | null | undefined;
            dbPermissions: {
    ...
    }>, "tx" | "sql">, _db: DB, { ip_address, ip_address_remote, user_agent, x_real_ip }: LoginClientInfo) => Promise<BasicSession>;
    logout: (sid: string | undefined, db: {
        access_control: import("prostgles-types").TableHandler<{
            created?: string | null | undefined;
            database_id?: number | null | undefined;
            dbPermissions: {
    ...
    }>, "tx" | "sql">, _db: DB) => Promise<boolean>;
    cacheSession: {
        getSession: (sid: string | undefined, db: {
            access_control: import("prostgles-types").TableHandler<{
                created?: string | null | undefined;
                database_id?: number | null | undefined;
                dbPermissions: {
    ...
    expressConfig: {
        ...
        magicLinks: {
            ...
            }>, "tx" | "sql">, db: DB, { ip_address, ip_address_remote, user_agent, x_real_ip }: LoginClientInfo) => Promise<BasicSession>;
        };
    };
};
