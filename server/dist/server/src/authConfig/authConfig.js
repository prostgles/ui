...
exports.getAuth = exports.getActiveSession = exports.sidKeyName = exports.makeSession = exports.YEAR = exports.HOUR = void 0;
...
const authCookieOpts = (process.env.PROSTGLES_STRICT_COOKIE || envVars_1.PROSTGLES_STRICT_COOKIE) ? {} : {
    secure: false,
    sameSite: "lax" //  "none"
};
...
const getAuth = (app) => {
    const auth = {
        ...
        getUser: async (sid, db, _db, client) => {
            ...
            if (!sid)
                return undefined;
            const s = await (0, exports.getActiveSession)(db, { type: "session-id", client, filter: { id: sid } });
            if (!s)
                return undefined;
        ...
        login: async ({ username = null, password = null, totp_token = null, totp_recovery_code = null } = {}, db, _db, { ip_address, ip_address_remote, user_agent, x_real_ip }) => {
            ...
            try {
                ...
                const hashedPassword = (0, authUtils_1.getPasswordHash)(userFromUsername, password);
            ...
            await onSuccess();
            const activeSession = await (0, exports.getActiveSession)(db, { type: "login-success", filter: { user_id: u.id } });
            if (!activeSession) {
        ...
        expressConfig: {
            ...
            magicLinks: {
                check: async (id, dbo, db, { ip_address, ip_address_remote, user_agent, x_real_ip }) => {
                    ...
                    const session = await (0, exports.makeSession)(user, { ip_address, user_agent: user_agent || null, type: (0, electronConfig_1.getElectronConfig)()?.isElectron ? "desktop" : "web" }, dbo, Number(mlink.expires));
