...
exports.getPidStatsFromProc = void 0;
const statusMonitorUtils_1 = require("./statusMonitorUtils");
const getPidStats_1 = require("./getPidStats");
const getPidStatsFromProc = async (db, connId) => {
  ...
  `;
    const pidInfo = await (0, statusMonitorUtils_1.execPSQLBash)(db, connId, pidCommand);
    const freqs = await (0, getPidStats_1.getCpuCoresMhz)(db, connId);
    const pidStats = pidInfo.map((line) => {
        ...
        */
        ...
        const mem_usage = Number.isFinite(vm_rss_kb) ? (100 * vm_rss_kb / total_memoryKb) : undefined;
        const mhz = freqs[procId ?? -1] ?? "";
        return {
            pid, name, utime, stime, cutime, cstime, starttime, vm_rss_kb,
            mhz,
            total_time, seconds,
            cpu_usage, mem_usage
        };
...
exports.getPidStatsFromProc = getPidStatsFromProc;
//# sourceMappingURL=getPidStatsFromProc.js.map