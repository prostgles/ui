...
exports.tableConfig = exports.DB_SSL_ENUM = void 0;
const Logger_1 = require("./Logger");
exports.DB_SSL_ENUM = ["disable", "allow", "prefer", "require", "verify-ca", "verify-full"];
...
const joinPath = { arrayOfType: { table: "string", on: { arrayOf: { record: { values: "any" } } } }, optional: true };
...
exports.tableConfig = {
    ...
    connections: {
        columns: {
            ...
            db_ssl: { enum: exports.DB_SSL_ENUM, nullable: false, defaultValue: "disable" },
    ...
    stats: {
        ...
        columns: {
            ...
            backend_start: { sqlDefinition: "TEXT NOT NULL", info: { hint: `Time when this process was started. For client backends, this is the time the client connected to the server.` } },
