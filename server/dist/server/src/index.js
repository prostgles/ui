...
exports.tout = exports.restartProc = exports.get = exports.onServerReady = exports.connMgr = exports.connectionChecker = exports.MEDIA_ROUTE_PREFIX = exports.log = exports.API_PATH = void 0;
...
app.use(function (req, res, next) {
    res.setHeader('Content-Security-Policy', " script-src 'self'; frame-src 'self'; worker-src blob: 'self';" /* data import (papaparse) requires: worker-src blob: 'self' */);
    next();
});
