...
export const tableConfig: TableConfig = {
  ...
  gas_prices: {
    ...
    onMount: async ({ dbo }) => {
      ...
      const gasCheckInterval = setInterval(async () => {
        ...
        markets.forEach(async market => {
          ...
          try {
            ...
            await dbo.markets.update({ id }, { fail_info: { error: error.message } });
      ...
      const clearDuplicatesInterval = setInterval(async () => {
        await dbo.sql(
          `
      ...
      return {
        onUnmount: () => {
          clearInterval(gasCheckInterval);
          clearInterval(clearDuplicatesInterval);
        }
      };
    }
  }
...
const MARKETS = {
  ...
  "sol": {
    ...
    "rpcNode": "https://solana-mainnet.phantom.app/YBPpkkN4g91xDiAnTE9r0RcMkjg0sKUIWvAfoFVJ"
  },
  "aptos": {
    "symbol": "APT",
    "chainName": "Aptos",
