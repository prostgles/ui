...
export const getCompiledTableConfig = ({ table_config, table_config_ts }: TableDbConfig): undefined | { tableConfig: any; dashboardConfig?: any; } => {
  ...
  if(!res.tableConfig) throw "A table_config_ts must export a const named 'tableConfig' "
  return res;
