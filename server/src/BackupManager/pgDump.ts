...
export async function pgDump(this: BackupManager, conId: string, credId: number | null, { options: o, destination, credentialID, initiator = "manual_backup" }: PGDumpParams){
