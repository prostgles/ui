...
export const getConnectionDetails = (c: Connections): Required<Pick<pg.IConnectionParameters<pg.IClient>, "application_name" | "host" | "port" | "password" | "user" | "ssl" | "database">> & { password: string } => {
  /**
