...
const { app_port, db_conn, db_host, db_port, db_name, db_user, db_pass, socket_path = "/iosckt" } = process.env;

console.log(process.env, JSON.stringify({app_port, db_conn, db_host, db_port, db_name, db_user, db_pass, socket_path}))
