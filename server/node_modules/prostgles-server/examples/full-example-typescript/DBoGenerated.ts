...
type DBO_airports = {
   ...
   subscribe: (filter: object, params: SelectParams, onData: (items: Airports[]) => any) => { unsubscribe: () => any };
   subscribeOne: (filter: object, params: SelectParams, onData: (item: Airports) => any) => { unsubscribe: () => any };
...
type DBO_planes = {
   ...
   subscribe: (filter: object, params: SelectParams, onData: (items: Planes[]) => any) => { unsubscribe: () => any };
   subscribeOne: (filter: object, params: SelectParams, onData: (item: Planes) => any) => { unsubscribe: () => any };
   count: (filter?: object) => Promise<number>;
