...
export default class ButtonGroup<Option extends string> extends React.Component<P<Option>, any> {
  ...
  render(){
    ...
    return (
      <FlexCol style={{ gap: ".5em", ...style }} className={className}>
        {label !== undefined && <Label label={typeof label === "string"? label : undefined} { ...(isObject(label)? label : {})} />}
        {buttons}
      </FlexCol>
    )
  }
