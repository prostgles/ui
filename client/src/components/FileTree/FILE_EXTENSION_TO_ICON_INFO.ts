...
> = {
  ...
  c: { iconPath: mdiFileDocumentOutline, label: "c", color: "#5c6bc0" },
  h: { iconPath: mdiFileDocumentOutline, label: "c header", color: "#5c6bc0" },
  cpp: { iconPath: mdiFileDocumentOutline, label: "c++", color: "#00599c" },
  ...
  rs: { iconPath: mdiFileDocumentOutline, label: "rust", color: "#ce422b" },
  php: { iconPath: mdiFileDocumentOutline, label: "php", color: "#777bb4" },
  swift: { iconPath: mdiFileDocumentOutline, label: "swift", color: "#f05138" },
  dart: { iconPath: mdiFileDocumentOutline, label: "dart", color: "#0175c2" },
  lua: { iconPath: mdiFileDocumentOutline, label: "lua", color: "#2c2d72" },
  r: { iconPath: mdiFileDocumentOutline, label: "r", color: "#276dc3" },
  ...
  pub: { iconPath: mdiApplicationCog, label: "public key", color: "#64748b" },
  crt: { iconPath: mdiApplicationCog, label: "certificate", color: "#64748b" },
  cer: { iconPath: mdiApplicationCog, label: "certificate", color: "#64748b" },
  csr: {
    iconPath: mdiApplicationCog,
