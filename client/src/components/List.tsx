...
type Items = {
  ...
  onPress: (e: React.MouseEvent<HTMLLIElement, globalThis.MouseEvent> | React.KeyboardEvent<HTMLLIElement>) => void;
...
export default class List extends React.Component<ListProps, any> {
  ...
  render(){
    ...
    const list = (
      <ul className={"list-comp f-1 o-auto min-h-0 min-w-0 no-scroll-bar" + className}
        role="list" 
              ...
              >
                {d.content || (
                  <>
                    ...
                    {d.contentRight || null}
                    {!checkedValues? null : <Checkbox className="f-0" checked={checkedValues.includes(d.key)} style={{ marginRight: "12px" }} />}
                  </>
                )}
              </DraggableLI>
            ))}
    ...
    if(anchorContent){
      ...
      >
        <div ref={e => { if(e) this.popupAnchor = e; }}
