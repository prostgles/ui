...
type P = {
  column?: Pick<Partial<ValidatedColumnInfo>, "is_pkey" | "tsDataType" | "udt_name">;
  value: string | null;
...
export const ShorterText = ({ value: guid, column, style }: P) => { 
  ...
  return (
    <div className="ShorterText flex-row gap-1 ai-center">
      {guid === null? <i>NULL</i> : 
      <>
        <div className="f-1 pointer relative" 
          style={{ 
            color: getColumnDataColor(column ?? { tsDataType: "string", udt_name: "uuid" }),
            ...(style ?? {}), 
          }}
