...
export const PopupHeader = ({ 
  subTitle, title, collapsible, 
  showFullscreenToggle, onToggleFullscreen, 
  headerRightContent, positioning, 
  onClose, collapsed, fullScreen, 
  toggleContent 
}: PopupHeaderProps) => {
  ...
  return  <header className={`${POPUP_CLASSES.title} ${(positioning === "right-panel"? "ml-2" : "pl-1")} py-p5 pr-p5 flex-row ai-center bb b-color gap-1`}>
