...
export const SmartFilterBarRightActions = (props: SmartFilterBarProps) => {
  ...
  const [updateAllRow, setUpdateAllRow] = useState<AnyObject | undefined>(undefined);
  ...
  if(hideSort && rightContent && (!showdelete && !showinsert && !showupdate)) return <></>;

  return <div className="ml-auto pl-1 flex-row ai-center">
        ...
        {!!tableHandler.update && showupdate && <PopupMenu
          ...
          render={pClose => (
            <>
              ...
              />
              {updateAllRow && <Footer>
                <Btn onClick={() => setUpdateAllRow(undefined)}>Cancel</Btn>
