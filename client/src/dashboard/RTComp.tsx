...
export default class RTComp<P = {}, S = {}, D = Record<string, any>> extends React.Component<P, S, D> {
  ...
  private logAsyncErr = (methodName: string, e: any) => {
    console.error(`Uncaught promise within ${methodName} of <${this.constructor.name}/> component`, e);
  }
  
  private _onDelta = (deltaP?: DeltaOf<P>, deltaS?: DeltaOf<S>, deltaD?: DeltaOfData<D>) => {
    (async () => {
