...
import { ForcedData, UpdateRule } from "../../../../../commonTypes/publishUtils";
...
import { ContextDataSchema } from "./FilterControl";
...
export const ForcedDataControl = (props: ForcedDataControlProps) => {
  ...
  return <FlexCol className="ForcedDataControl"> 
    ...
    {!showEditor && !!fDataValues?.length && 
      <FlexCol className="gap-p5 ai-start b b-gray-300 rounded p-1 ml-3 w-fit shadow" style={{   }}>
