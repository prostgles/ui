...
import { ForcedData } from "../../../../../commonTypes/publishUtils";
...
import { ForcedDataControlProps } from "./ForcedDataControl";
...
export const ForcedDataForm = ({ 
  ...
  return <FlexCol className="gap-2 p-1 ml-2 rounded b b-gray-300  shadow">
