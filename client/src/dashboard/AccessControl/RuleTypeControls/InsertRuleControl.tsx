...
export const InsertRuleControl = ({ rule: rawRule, onChange, table, prgl, tableRules, contextDataSchema: contextData, userTypes }: P) => {
  const rule: InsertRule | undefined = rawRule === true? { fields: "*" } : isObject(rawRule)? rawRule : undefined;
  const error = null;
