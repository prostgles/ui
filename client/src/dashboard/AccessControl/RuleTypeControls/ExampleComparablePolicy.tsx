...
import type { DeleteRule, InsertRule, SelectRule, UpdateRule } from "../../../../../commonTypes/publishUtils";
...
export const ExampleComparablePolicy = (p: P) => {
  ...
  const policy = usePromise(async () => getComparablePGPolicy({ 
  ...
  return <FlexCol>
    ...
    {policy && <FlexCol className="gap-p5 ml-3 p-1">
      <div className="text-2 ai-start">Policy that may be used in postgres to replicate some of the rules above</div>
      <CodeExample 
        language="sql" 
