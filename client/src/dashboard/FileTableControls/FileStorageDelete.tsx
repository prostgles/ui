...
type P = Pick<FileStorageControlsProps, "connection" | "dbsMethods" | "database_config"> & { 
  onClose: VoidFunction; 
  db: PrglCore["db"] 
};

export const FileStorageDelete = ({ dbsMethods, connection, db, onClose, database_config }: P) => {
