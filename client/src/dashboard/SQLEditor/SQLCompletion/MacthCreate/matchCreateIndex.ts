...
${indexInfoUrl}` 
    ...
    },
    {
      ...
      options: [
        ...
        { label: "deduplicate_items = off", docs: `Controls usage of the B-tree deduplication technique described in Section 67.4.3. Set to ON or OFF to enable or disable the optimization. (Alternative spellings of ON and OFF are allowed as described in Section 20.1.) The default is ON.` },
        { label: "gin_pending_list_limit = 1024", docs: `Custom gin_pending_list_limit parameter. This value is specified in kilobytes.` },
        { label: "pages_per_range = 23", docs: `Defines the number of table blocks that make up one block range for each entry of a BRIN index (see Section 71.1 for more details). The default is 128.` },
