...
export const MatchFirst = async ({
  ...
  if(cb.currNestingFunc?.textLC === "to_char" && currToken?.type === "string.sql"){
    ...
    if(func?.prevArgs.length){
      ...
      return suggestSnippets(TO_CHAR_PATTERNS.map(p => ({ 
        label: p.label,
        ...opts, 
...
{ label: "A.M., a.m., P.M. or p.m.	", docs: `meridiem indicator (with periods)` },
...
{ label: "MONTH",	docs: `full upper case month name (blank-padded to 9 chars)` },
{ label: "Month",	docs: `full capitalized month name (blank-padded to 9 chars)` },
{ label: "month",	docs: `full lower case month name (blank-padded to 9 chars)` },
{ label: "MON",	docs: `abbreviated upper case month name (3 chars in English, localized lengths vary)` },
{ label: "Mon",	docs: `abbreviated capitalized month name (3 chars in English, localized lengths vary)` },
{ label: "mon",	docs: `abbreviated lower case month name (3 chars in English, localized lengths vary)` },
...
{ label: "DY",	docs: `abbreviated upper case day name (3 chars in English, localized lengths vary)` },
{ label: "Dy",	docs: `abbreviated capitalized day name (3 chars in English, localized lengths vary)` },
{ label: "dy",	docs: `abbreviated lower case day name (3 chars in English, localized lengths vary)` },
{ label: "DDD",	docs: `day of year (001-366)` },
{ label: "IDDD",	docs: `day of ISO 8601 week-numbering year (001-371; day 1 of the year is Monday of the first ISO week)` },
...
{ label: "W",	docs: `week of month (1-5) (the first week starts on the first day of the month)` },
{ label: "WW",	docs: `week number of year (1-53) (the first week starts on the first day of the year)` },
{ label: "IW",	docs: `week number of ISO 8601 week-numbering year (01-53; the first Thursday of the year is in week 1)` },
{ label: "CC",	docs: `century (2 digits) (the twenty-first century starts on 2001-01-01)` },
{ label: "J",	docs: `Julian Date (integer days since November 24, 4714 BC at local midnight; see Section B.7)` },
{ label: "Q",	docs: `quarter` },
{ label: "RM",	docs: `month in upper case Roman numerals (I-XII; I=January)` },
{ label: "rm",	docs: `month in lower case Roman numerals (i-xii; i=January)` },
{ label: "TZ",	docs: `upper case time-zone abbreviation (only supported in to_char)` },
{ label: "tz",	docs: `lower case time-zone abbreviation (only supported in to_char)` },
{ label: "TZH",	docs: `time-zone hours` },
{ label: "TZM",	docs: `time-zone minutes` },
{ label: "OF",	docs: `time-zone offset from UTC (only supported in to_char)` }
]