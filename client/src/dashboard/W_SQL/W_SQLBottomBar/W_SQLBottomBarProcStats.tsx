...
export const W_SQLBottomBarProcStats = ({ dbsMethods, dbs, connectionId, activeQuery }: W_SQLBottomBarProps) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      const procInfo = await dbs.stats.findOne({ connection_id: connectionId, pid });
