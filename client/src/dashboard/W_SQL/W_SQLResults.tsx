...
type W_SQLResultsProps = Pick<W_SQLState, "sqlResult" | "rows" | "notifEventSub" | "notices" | "cols" | "activeQuery" | "sort" | "page" | "pageSize" | "isSelect"> & 
...
export const W_SQLResults = (props: W_SQLResultsProps) => {
  const { 
    sqlResult, notifEventSub, notices, rows = [], cols = [], 
    activeQuery, childWindow, sort, w, tables, page, 
