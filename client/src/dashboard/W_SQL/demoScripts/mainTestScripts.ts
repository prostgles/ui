...
export const mainTestScripts: DemoScript = async ({ testResult, fromBeginning, typeAuto, moveCursor, typeText, newLine, runSQL, triggerSuggest, runDbSQL, getEditor, acceptSelectedSuggestion }) => {
