import { mdiFileUploadOutline, mdiFunction, mdiPlus, mdiTable, mdiUpload } from "@mdi/js";
...
const items = [
  ...
  { key: "Import file", label: "Import file", subLabel: "Supported types: csv/geojson/json", iconPath: mdiFileUploadOutline },
  { key: "newMethod", label: "Create TS Function", subLabel: "(Experimental)", iconPath: mdiFunction },
