...
type P = Pick<DashboardMenuProps, "loadTable"> & {
  setShowSearchAll: React.Dispatch<React.SetStateAction<DashboardMenuState["showSearchAll"]>>;
}
export const DashboardMenuHotkeys = ({ loadTable, setShowSearchAll }: P) => {
  ...
  const fileSelected: React.ChangeEventHandler<HTMLInputElement> = async (e) => {
