import type { DBHandlerClient, TableHandlerClient } from "prostgles-client/dist/prostgles";
import type { AnyObject, ValidatedColumnInfo } from "prostgles-types";
import type { DetailedFilterBase, SimpleFilter, SmartGroupFilter } from "../../../../commonTypes/filterUtils";
...
type ComputedColumn = Pick<ValidatedColumnInfo, "name" | "label" | "tsDataType" | "udt_name"> & { 
  type: "computed";
