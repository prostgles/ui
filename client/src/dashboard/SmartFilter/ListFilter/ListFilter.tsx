      ...
      this.searching = {
        ...
        timeout: setTimeout(async () => {
          ...
          try {
            ...
            const { options = [] } = await fetchListFilterOptions({ db, column, tableName, tables, otherFilters, term });

            let newState: Partial<ListFilterState> = { options, searchingItems: false, error: undefined };
