  ...
  return (
    <FlexCol className="ai-start o-auto">
      <div className="ta-left p-p5">
        When row level security is enabled all normal access to the table for selecting or modifying rows must be allowed by a row security policy. 
        <br/>
        <br/>
      ...
      <SmartCardList
        ...
        noDataComponent={
          <InfoRow color="info">No policies</InfoRow>
        }
        fieldConfigs={[
          {
            name: "definition",
              ...
              <FlexCol>
                <Select
                  ...
                  fullOptions={[
                    ...
                    {
                      key: "USING",
                      subLabel: "Change which rows (or the condition) the policy applies to"
                    },
                    {
                      key: "WITH CHECK",
