...
import { DBSchemaTablesWJoins, OnAddChart, PALETTE, WindowData } from '../../Dashboard/dashboardUtils';
import { ChartColumn, getChartColsV2 } from './getChartCols';
...
const CHART_TYPES = ["map", "timechart"] as const;


export default class AddChartMenu extends React.Component<P, {
