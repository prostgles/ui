...
export const ProjectConnection = (props: ProjectProps) => {
  ...
  const {
    error, prglProject, state, connNotFound
  } = useProjectDb({ prglState, connId: params.cid });
  ...
  return (
    <div className="Project f-1 flex-col h-full w-full min-h-0 min-w-0 relative bg-color-4"
      style={{
