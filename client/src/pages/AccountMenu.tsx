...
import { mdiAccountOutline, mdiAccountStarOutline, mdiLogin, mdiLogout } from "@mdi/js";
...
export const AccountMenu = ({ user, forNavBar }: P) => {
  ...
  const iconPath = user.type === "admin"? mdiAccountStarOutline : mdiAccountOutline; 
  ...
  return <PopupMenu
    ...
    button={(
      ...
      >
        ...
        {!window.isLowWidthScreen && <div className=" text-2 font-12 ws-nowrap">{user.username}</div>}
      </Btn>
    )}
  >
