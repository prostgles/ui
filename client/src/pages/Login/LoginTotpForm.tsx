...
export const LoginTotpFormFields = ({ formHandlers, onAuthCall, setState }: ReturnType<typeof useLoginState>) => {
  if(!formHandlers || formHandlers.state !== "loginTotp" && formHandlers.state !== "loginTotpRecovery") return null;
  ...
  return formHandlers.state === "loginTotp"? <>
    ...
    />
    <Btn type="button" color="action" size="small" onClick={() => setState("loginTotp")}>Cancel</Btn>
  </>
}