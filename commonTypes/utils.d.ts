...
export declare const QUERY_WATCH_IGNORE =
...
export declare const getAge: <ReturnALL extends boolean = false>(
  date1: number,
  date2: number,
  returnAll?: ReturnALL | undefined,
...
export declare function matchObj(
  obj1: AnyObject | undefined,
  obj2: AnyObject | undefined,
): boolean;
export declare function sliceText(
  v: string | undefined,
  maxLen: number,
  ellipseText?: string,
  midEllipse?: boolean,
...
export declare function throttle<Params extends any[]>(
  func: (...args: Params) => any,
  timeout: number,
): (...args: Params) => void;
export declare const SPOOF_TEST_VALUE = "trustme";
export declare const getEntries: <T extends AnyObject>(
  obj: T,
) => [keyof T, T[keyof T]][];
export declare const CONNECTION_CONFIG_SECTIONS: readonly [
  "access_control",
  "backups",
  "table_config",
  "details",
