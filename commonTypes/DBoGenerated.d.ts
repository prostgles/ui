...
export type DBSchemaGenerated = {
  access_control: {
    ...
    columns: {
      ...
      dbsPermissions?: null | {
        ...
        viewPublishedWorkspaces?: { workspaceIds: string[] };
      };
      id?: number;
  ...
  connections: {
    ...
    columns: {
      ...
      db_pass?: null | string;
      db_port?: number;
      db_schema_filter?: null | Record<string, 1> | Record<string, 0>;
      db_ssl?:
        | "disable"
        | "allow"
        | "prefer"
  ...
  database_configs: {
    ...
    columns: {
      ...
      db_name: string;
      db_port: number;
      file_table_config?: null | {
        fileTable?: string;
        storageType: { type: "local" } | { type: "S3"; credential_id: number };
      ...
      auth_providers?: null | {
        ...
        email?:
          | {
              ...
              emailTemplate?: { from: string; subject: string; body: string };
        ...
        github?: {
          ...
          clientID: string;
          clientSecret: string;
          authOpts?: { scope: ("read:user" | "user:email")[] };
        };
        microsoft?: {
          enabled?: boolean;
          clientID: string;
          clientSecret: string;
          authOpts?: {
            prompt: "login" | "none" | "consent" | "select_account" | "create";
            scope: (
              | "openid"
              | "profile"
              | "email"
      ...
      arguments?: (
        ...
        | {
            ...
            lookup: {
              ...
              isFullRow?: { displayColumns?: string[] };
              showInRowCard?: Record<string, any>;
            };
          }
      )[];
      connection_id?: null | string;
  ...
  workspaces: {
    ...
    columns: {
      ...
      options?: {
        hideCounts?: boolean;
        tableListEndInfo?: "none" | "count" | "size";
        tableListSortBy?: "name" | "extraInfo";
        showAllMyQueries?: boolean;
        defaultLayoutType?: "row" | "tab" | "col";
        pinnedMenu?: boolean;
        pinnedMenuWidth?: number;
      };
