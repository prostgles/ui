...
export declare const JOINED_FILTER_TYPES: readonly [
  "$existsJoined",
  "$notExistsJoined",
];
...
export declare const isDetailedFilter: (
  f: SimpleFilter,
) => f is DetailedFilterBase;
type InfoType = "pg";
export declare const getFinalFilterInfo: (
...
export declare const parseContextVal: (
...
export declare const getFinalFilter: (
