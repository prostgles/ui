...
declare const OBJ_DEF_TYPES: readonly [
  "boolean",
  "string",
  "number",
  "Date",
...
export declare function isObject<T extends Record<string, any>>(
  obj: any,
): obj is T;
...
export declare const parseFullFilter: (
...
export declare const parseCheckForcedFilters: (
...
export declare const parseTableRules: (
  rules: TableRules,
...
export declare const getTableRulesErrors: (
  rules: TableRules,
  tableColumns: string[],
  contextData: ContextDataObject,
) => Promise<TableRulesErrors>;
export declare const validateDynamicFields: (
