...
const likeInfo =
  "Operators: '%' - match any sequence of characters; '_' - match any single character ";
...
export const GEO_FILTER_TYPES = [{ key: "$ST_DWithin", label: "Within" }];
export const JOINED_FILTER_TYPES = ["$existsJoined", "$notExistsJoined"];
export const isJoinedFilter = (f) =>
  Boolean(f.type && JOINED_FILTER_TYPES.includes(f.type));
...
export const getFinalFilterInfo = (fullFilter, context, depth = 0, opts) => {
  ...
  const filterToString = (filter) => {
    ...
    const f = getFinalFilter(filter, context, {
      forInfoOnly:
        (
          (_b = opts === null || opts === void 0 ? void 0 : opts.for) !==
            null && _b !== void 0
        ) ?
          _b
        : true,
    ...
    if (
      "fieldName" in filter &&
      ((_c = filter.contextValue) === null || _c === void 0 ?
        void 0
      : _c.objectName) === "user"
    ) {
  ...
  if (fullFilter) {
    ...
    return (_a = filterToString(fullFilter)) !== null && _a !== void 0 ?
        _a
      : "";
  }
  return result;
...
export const parseContextVal = (f, context, { forInfoOnly } = {}) => {
  ...
  if (f.contextValue) {
    ...
    if (context) {
      //@ts-ignore
      return (
          (_a = context[f.contextValue.objectName]) === null || _a === void 0
        ) ?
          void 0
        : _a[f.contextValue.objectPropertyName];
    }
    return undefined;
  }
...
export const getFinalFilter = (detailedFilter, context, opts) => {
  ...
  const getFilter = (f, columns) => {
    ...
    if (
      ...
      const fieldName = checkFieldname(
        f.fieldName,
        opts === null || opts === void 0 ? void 0 : opts.columns,
      );
      ...
      f.complexFilter ||
      ((_a = f.type) === null || _a === void 0 ?
        void 0
      : _a.startsWith("$age")) ||
      f.type === "$duration"
    ) {
      const isAgeOrDuration =
        ((_b = f.type) === null || _b === void 0 ?
          void 0
        : _b.startsWith("$age")) || f.type === "$duration";
      if (isAgeOrDuration) {
        ...
        const {
          ...
          otherField,
        } = (_c = f.complexFilter) !== null && _c !== void 0 ? _c : {};
        const filterArgs =
          f.type === "$age" ?
            [fieldName]
